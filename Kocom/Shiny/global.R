...
mongo_db <- CEMS::connectMongo(DB="publicdata", port=50000)
mongo_user <- CEMS::connectMongo(DB="userdata", port=50000)
mongo_service <- CEMS::connectMongo(DB="clouddata", port=50000)
mongo_tg <- CEMS::connectMongo(DB="sensordata", port=50000)
